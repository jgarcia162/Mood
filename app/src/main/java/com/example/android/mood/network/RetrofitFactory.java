...
public class RetrofitFactory {
    ...
    public static Retrofit getAerisInstance() {
        if (aerisInstance == null) {
            aerisInstance = new Retrofit.Builder().baseUrl(AerisConstants.BASE_URL).addConverterFactory(GsonConverterFactory.create()).build();
        }
    ...
    public static Retrofit getPoetryInstance() {
        if (poetryInstance == null) {
            poetryInstance = new Retrofit.Builder().baseUrl(PoetryConstants.BASE_URL).addConverterFactory(GsonConverterFactory.create()).build();
        }
